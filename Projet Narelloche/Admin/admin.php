        ...
        <section class="page-section bg-primary text-white" id="about">
            <div class="container">
                ...
                <div class="ms-auto text-center lead">
                    <a href='admin.php?sort=recent' class='btn-create-ticket'>Plus récents</a>
                    <a href='admin.php?sort=old' class='btn-create-ticket'>Plus anciens</a>
                    <div class="dropdown">
                        <button class="dropbtn btn-create-ticket">Statut</button>
                    ...
                    <div class="dropdown">
                        <button class="dropbtn btn-create-ticket">Priorité</button>
                        <div class="dropdown-content">
