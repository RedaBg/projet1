    ...
    <body id="page-top" class="bg-primary">
        ...
        <header class="masthead bg-primary text-white text-center" style="height: 100vh;">
            <div class="container d-flex align-items-center flex-column">
                <h1 class="masthead-heading text-uppercase mb-0">Créer un compte</h1>
                ...
                <form action="create.php" method="post">
                    ...
                    <input type="submit" name="create" class="btn mt-3 mb-3 btn-primary border border-white"  value="Créer mon compte">
                </form>
            </div>
            <div>
